...
public class RouteAdapter extends ArrayAdapter<Stop> {
    ...
    private static final int milisecondMultiplier = 60000;
    ...
    private void doNotificationBusiness(int id) {
        ...
        switch (id) {
            case 0:
                delay = milisecondMultiplier / 6;
                break;
            case 1:
                delay = 5 * milisecondMultiplier;
                break;
            case 2:
                delay = 10 * milisecondMultiplier;
                break;
            case 3:
                delay = 15 * milisecondMultiplier;
                break;
            default:
                delay = 0;
                break;
